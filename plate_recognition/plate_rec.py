...
def allFilePath_img(rootPath,allFIleList):
    fileList = os.listdir(rootPath)
    for temp in fileList:
        if os.path.isfile(os.path.join(rootPath,temp)):
            if temp.endswith('.jpg') or temp.endswith('.png') or temp.endswith('.JPG'):
            ...
            allFilePath_img(os.path.join(rootPath,temp),allFIleList)

def allFilePath_txt(rootPath,allFIleList):
    fileList = os.listdir(rootPath)
    for temp in fileList:
        if os.path.isfile(os.path.join(rootPath,temp)):
            ...
            allFilePath_txt(os.path.join(rootPath,temp),allFIleList)
